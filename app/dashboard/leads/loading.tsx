    ...
    <main className="min-h-screen bg-[#06090F] px-5 py-8 text-white sm:px-8 sm:py-10">
      <div className="mx-auto max-w-7xl animate-pulse">
        ...
        <section className="rounded-3xl border border-white/10 bg-white/[0.025] p-6 sm:p-8">
          ...
          <div className="mt-5 h-10 w-3/4 max-w-xl rounded-xl bg-white/10" />
        ...
        <section className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[1, 2, 3, 4].map((item) => (
            ...
            >
              ...
              <div className="mt-3 h-9 w-20 rounded-xl bg-white/10" />
            </div>
          ))}
        </section>

        {/* Search */}
        <section className="mt-6 h-14 rounded-2xl border border-white/10 bg-white/[0.025]" />
          ...
          <div className="divide-y divide-white/[0.06]">
            {[1, 2, 3, 4, 5].map((item) => (
              ...
              >
                ...
                <div className="hidden h-8 w-24 rounded-xl bg-white/[0.06] sm:block" />
                <div className="hidden h-8 w-20 rounded-xl bg-white/[0.06] sm:block" />
              </div>
            ))}
          </div>
        </section>
